...
let pokemonsCollection : typeof MongoClient.Collection;
 ...
 */
async function initialize(dbName : string, reset : boolean, url : string) {
    try {
 ...
 */
async function addPokemon(name : string, type : string) {
 ...
 */
async function findSinglePokemon(name : string) {
    try {
